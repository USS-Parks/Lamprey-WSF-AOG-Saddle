...
# `USS-Parks/Lamprey-WSF-AOG-Saddle/.github/workflows/supply-chain.yml@refs/tags/v1.2.3`);
...
IDENTITY_REGEXP="${COSIGN_CERT_IDENTITY_REGEXP:-^https://github\.com/USS-Parks/Lamprey-WSF-AOG-Saddle/\.github/workflows/supply-chain\.yml@refs/(tags/v[0-9][A-Za-z0-9.+-]*|heads/main)$}"
