...
- [ ] **SAD-03 — Prove the no-secret import path.** Build the tracked-file archive/allowlist, run independent secret scanners, identify runtime-generated PKI/state, and define replacement generation scripts.
