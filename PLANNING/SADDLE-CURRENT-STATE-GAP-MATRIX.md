...
| Saddle identity | Missing | No active `saddle-*` packages exist in the baseline; the source manifest found 120 tracked files containing Loom identity patterns. | Apply the canonical 12-package rename and eliminate active Loom runtime, protocol, deployment, and documentation identity. |
