...
@pytest.mark.parametrize(
    ...
    [
        (
            400,
            {"error": {"code": "MAI-1001", "type": "invalid_request", "message": "bad"}},
        ),
        (
            401,
            {
        ...
        (
            404,
            {"error": {"code": "MAI-2001", "type": "internal_error", "message": "missing"}},
        ),
        (409, {"error": {"code": "MAI-5001", "type": "conflict", "message": "conflict"}}),
        (
            413,
            {"error": {"code": "MAI-1002", "type": "invalid_request", "message": "too big"}},
        ),
        (
            415,
            {"error": {"code": "MAI-1003", "type": "invalid_request", "message": "media"}},
        ),
        (
            422,
            {
