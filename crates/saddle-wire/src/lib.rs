//! `saddle-wire` — the over-the-wire Raft transport for the containerized Saddle
...
//! Raft handle. This is the wire counterpart of `saddle-store`'s in-process
...
use saddle_store::raft::types::{NodeId, TypeConfig};
use serde::Serialize;
